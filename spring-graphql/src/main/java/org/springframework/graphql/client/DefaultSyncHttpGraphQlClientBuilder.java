...
/**
 * Default {@link SyncHttpGraphQlClient.Builder} implementation, a simple wrapper
...
final class DefaultSyncHttpGraphQlClientBuilder
		...
		implements SyncHttpGraphQlClient.Builder<DefaultSyncHttpGraphQlClientBuilder>  {
	...
	@Override
	public SyncHttpGraphQlClient build() {
		...
		SyncHttpGraphQlTransport syncTransport = new SyncHttpGraphQlTransport(restClient);

		GraphQlClient graphQlClient = super.buildGraphQlClient(syncTransport);
		return new DefaultSyncHttpGraphQlClient(graphQlClient, restClient, getBuilderInitializer());
	}
	 ...
	 */
	private static class DefaultSyncHttpGraphQlClient
			extends AbstractDelegatingGraphQlClient implements SyncHttpGraphQlClient {

		private final RestClient restClient;

		private final Consumer<AbstractGraphQlClientSyncBuilder<?>> builderInitializer;

		DefaultSyncHttpGraphQlClient(
