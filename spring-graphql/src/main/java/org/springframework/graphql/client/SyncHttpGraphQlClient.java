 ...
 * @since 1.3
 */
public interface SyncHttpGraphQlClient extends GraphQlClient {
	...
	/**
	 * Create an {@link SyncHttpGraphQlClient} that uses the given {@link RestClient}.
	 */
	static SyncHttpGraphQlClient create(RestClient client) {
		return builder(client.mutate()).build();
	}

	/**
	 * Return a builder to initialize an {@link SyncHttpGraphQlClient} with.
	 */
